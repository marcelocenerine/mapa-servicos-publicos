...
function formatInfoWindowText(ponto) {
        ...
        text += '<div><img src="http://maps.googleapis.com/maps/api/streetview?size=300x200&fov=110&pitch=10&location='+ ponto.localizacao.coordenadas.latitude + ',%20' + ponto.localizacao.coordenadas.longitude + '&sensor=false" /></div>';
        if (ponto.nome) {
