...
function formatInfoWindowText(ponto) {
        ...
        text += '<p><a href="#" onclick="javascript:closeInfoWindow();drawRoute('+ ponto.localizacao.coordenadas.latitude + ',' + ponto.localizacao.coordenadas.longitude + ', 1);">Como chegar a pé?</a></p>';
        text += '<p><a href="#" onclick="javascript:closeInfoWindow();drawRoute('+ ponto.localizacao.coordenadas.latitude + ',' + ponto.localizacao.coordenadas.longitude + ', 0);">Como chegar de carro?</a></p>';
